module.exports = {
    cap: {
        ...
        monotype: function (room, user, args) {
            ...
            room.send(
                "/tour rules +darmanitan-galar, +Dracovish, +Urshifu, +Spectrier, +Blaziken, -Cawmodore, -Kartana, -Magearna, -Damp Rock, -Smooth Rock, -Terrain Extender"
            );
        },
        ...
        uu: function (room, user, args) {
            ...
            room.send(
                "/tour rules +CAP, +CAP NFE, +CAP LC, -Syclant, -Krilowatt, -Tomohawk, -Cawmodore, -Volkraken, Naviathan, -Kerfluffle, -Pajantom, -Jumbao, -Smokomodo, -Equilibra, -Astrolotl"
            );
        },
        // other
