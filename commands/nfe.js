module.exports = {
    nfe: {
        ...
        gen7: function (room, user, args) {
            ...
            room.send(
                "/tour rules Not Fully Evolved, -Chansey, -Doublade, -Gligar, -Golbat, -Gurdurr, -Magneton, -Piloswine, -Porygon2, -Rhydon, -Scyther, -Sneasel, -Type: Null, -Vigoroth, -Drought, -Aurora Veil"
            );
        },
        oras: "gen6",
        gen6: function (room, user, args) {
            ...
            room.send(
                "/tour rules Not Fully Evolved, +All Pokemon, -Chansey, -Doublade, -Magneton, -Porygon2, -Rhydon, -Scyther, -Arena Trap, -Drought, -Moody, -Shadow Tag, -Swagger, -Baton Pass"
            );
        },
        gen5: function (room, user, args) {
            ...
            room.send(
                "/tour rules Not Fully Evolved, -Chansey, -Dusclops, -Fraxure, -Gligar, -Golbat, -Gurdurr, -Haunter, -Machoke, -Magmar, -Magneton, -Riolu, -Rhydon, -Piloswine, -Porygon2, -Scyther, -Vigoroth"
            );
        },
        gen4: function (room, user, args) {
            ...
            room.send(
                "/tour rules Not Fully Evolved, +NU, +RU, +UU, +OU, +UUBL, +RUBL, +NUBL, +PUBL, +PU, +Uber, -Chansey, -Dragonair, -Dusclops, -Electabuzz, -Haunter, -Machoke, -Magmar, -Magneton, -Porygon2, -Rhydon, -Scyther, -Sneasel"
            );
        },
        gen3: function (room, user, args) {
            ...
            room.send(
                "/tour rules Not Fully Evolved, -Abra, -Diglett, -Dragonair, -Golbat, -Haunter, -Metang, -Vigoroth, -Light Ball"
            );
        },
        // OMs
        ...
        aaa: function (room, user, args) {
            ...
            room.send(
                "/tour rules Not Fully Evolved, -Chansey, -Gurdurr, -Piloswine, -Rhydon, -Scyther, -Sneasel, -Electabuzz"
            );
        },
        ubers: function (room, user, args) {
            ...
            room.send(
                "/tour rules +Doublade, +Gurdurr, +Ivysaur, +Mr. Mime-Galar, +Pawniard, +Rhydon, +Rufflet, +Sneasel, +Type: Null, !Dynamax Clause"
            );
        },
        ...
        uu: function (room, user, args) {
            ...
            room.send(
                "/tour rules -Thwackey, -Gurdurr, -Electabuzz, -Piloswine, -Golbat, -Raboot, -Kadabra, -Pikachu, -Clefairy, -Wartortle, -Tangela, -Hattrem, -Corsola-Galar, -Magmar, -Carkol, -Togetic, -Gabite, -Mr. Mime-Galar, -Dusclops, -Klang, -Charjabug, -Mareanie, -Ferroseed, -Slowpoke, -Marshtomp, -Fraxure, -Lampent, -Krokorok"
            );
        ...
        mnm: function (room, user, args) {
            ...
            room.send(
                "/wall The following pokemon are not allowed to mega-evolve, if your opponent uses them tell a staff member so they can be disqualified: Chansey, Rhydon, Scyther and Gligar"
            );
        },
        stab: "stabmons",
        stabmons: function (room, user, args) {
            ...
            room.send(
                "/tour rules Not Fully Evolved, -Chansey, -Haunter, -Yanma, -Dewpider, -King's Rock, -Razor Fang"
            );
        },
        // other
